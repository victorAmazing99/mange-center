...
public class PreAuthorizeAspect {
     ...
     */
    public static final String POINTCUT_SIGN = " @annotation(com.victor.common.security.annotation.RequiresLogin) || "
            + "@annotation(com.victor.common.security.annotation.RequiresPermissions) || "
            + "@annotation(com.victor.common.security.annotation.RequiresRoles)";
